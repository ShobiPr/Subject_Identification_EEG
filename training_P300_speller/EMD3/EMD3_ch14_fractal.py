...
logging.basicConfig(filename='EMD3_P300_ch14_fractal.log',
                    level=logging.INFO,
                    format='%(asctime)s %(levelname)-8s %(message)s')


def main():
    logging.info(" ***** EMD3, CHANNELS:14, FEATURES: fractal ***** \n")
    INSTANCES = [10, 20, 40, 60]
    sr = 200
    ch = [4, 5, 7, 9, 13, 15, 17, 23, 25, 33, 43, 51, 55, 56]
    for ins in INSTANCES:
        ...
        for subject in range(1, 27):  # 26
            for session in range(1, 5):  # 4
                ...
                for f_instance in range(0, ins):
                    ...
                    ch_fs_instances.append(get_features_emd(instance, sr))  # CHANNELS: 14
        ...
        # saving the model
        model_name = 'EMD3_P300_ch14_fractal_ins%02d.sav' % ins
