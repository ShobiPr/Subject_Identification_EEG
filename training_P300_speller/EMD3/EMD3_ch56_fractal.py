...
logging.basicConfig(filename='EMD3_P300_ch56_fractal.log',
                    level=logging.INFO,
                    format='%(asctime)s %(levelname)-8s %(message)s')


def main():
    logging.info(" ***** EMD3, CHANNELS:56, FEATURES: fractal ***** \n")
    ...
    for ins in INSTANCES:
        ...
        # saving the model
        model_name = 'EMD3_P300_ch56_fractal_ins%02d.sav' % ins
