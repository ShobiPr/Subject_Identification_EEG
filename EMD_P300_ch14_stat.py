...
from features import get_imfs_emd, get_statistics_values
...
logging.basicConfig(filename='EMD_P300_ch14_stat.log',
                    level=logging.INFO,
...
def main():
    logging.info(" ***** CHANNELS:14, FEATURES: stat ***** \n")
    ...
    for ins in INSTANCES:
        ...
        # saving the model
        model_name = 'EMD_P300_ch14_stat_ins%02d.sav' % (ins)
