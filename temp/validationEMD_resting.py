...
logging.basicConfig(filename='Validation_EMD_resting_energy_marg_.log',
                    level=logging.INFO,
...
for ins in [10, 20]:
    ...
    for subject in range(1, no_subjects + 1):
        ...
        logging.info(" -------- validation: energy + marg --------")
        file_name = 'EMD_resting_energy_marg_ins%2d.sav' % ins
