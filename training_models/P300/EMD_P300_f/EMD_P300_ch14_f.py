...
from features import get_imfs_emd, get_values_f
...
logging.basicConfig(filename='EMD_P300_ch14_f.log',
                    level=logging.INFO,
...
def main():
    logging.info(" ***** CHANNELS:14, FEATURES: f ***** \n")
    ...
    for ins in INSTANCES:
        ...
        # saving the model
        model_name = 'EMD_P300_ch14_f_ins%02d.sav' % (ins)
