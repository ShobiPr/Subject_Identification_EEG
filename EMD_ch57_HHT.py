...
logging.basicConfig(filename='EMD_P300_ch57_HHT.log',
                    level=logging.INFO,
...
def main():
    logging.info(" ***** CHANNELS:57, FEATURES: HHT ***** \n")
    ...
    for ins in INSTANCES:
        ...
        for subject in range(1, 27):  # 26
            for session in range(1, 5):  # 4
                ...
                for f_instance in range(0, ins):
                    ...
                    ch_fs_instances.append(get_features(instance, sr))  # CHANNELS:8
        ...
        # saving the model
        model_name = 'EMD_P300_ch57_HHT_ins%02d.sav' % (ins)
